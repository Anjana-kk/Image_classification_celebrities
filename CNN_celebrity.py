...
image_dir=r"C:\Users\user\Downloads\Dataset_Celebrities\cropped"
...
plt.savefig(r'C:\Users\user\Downloads\Dataset_Celebrities\cropped\Results\accuracy_plot.png')
...
plt.savefig(r'C:\Users\user\Downloads\Dataset_Celebrities\cropped\Results\loss_plot.png')
...
submission.to_csv(r"C:\Users\user\Downloads\Dataset_Celebrities\cropped\Results\Image_CNN.csv",index=False) 
print("--------------------------------------\n")